...
namespace petit
{
    public class Dashboardpetit : Control
    {
        // 表盘与刻度适配， 但是指针还没有，指针还是按照40度执行
        private int offsetAngle = 120;//左右两侧各偏移的角度   
        private int offsetOuter = 5;//距离各侧边的偏移量
        private int roundSize = 6;// 进度条宽度

        private int indicatorCenterR = 8;//指针半径（中心点合并角度的半径）

        private int minWidth = 160;//最小宽度
        private int minHeight = 160;//最小高度
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            int startAngle = 180;//开始角度：从x轴正方向，逆时针旋转画弧
            int sweepAngle = 120;//整个圆弧的角度
            ...
            //2、绘制内侧圆:最中间的
            Rectangle rectangleCircle = new Rectangle(centerX-10, centerY-10 , 20, 20);
